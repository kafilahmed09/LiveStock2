...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BES.Models.Data.BLEnrollment", b =>
                {
            ...
            modelBuilder.Entity("BES.Models.Data.BLFacilitiesInfo", b =>
                {
            ...
            modelBuilder.Entity("BES.Models.Data.BLFeederDetail", b =>
                {
            ...
            modelBuilder.Entity("BES.Models.Data.BLFeederSchool", b =>
                {
                    b.Property<short>("BLFeederSchoolID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BES.Models.Data.BLLandAvailable", b =>
                {
            ...
            modelBuilder.Entity("BES.Models.Data.BLPTSMCInfo", b =>
                {
            ...
            modelBuilder.Entity("BES.Models.Data.BLTeacherDetail", b =>
                {
            ...
            modelBuilder.Entity("BES.Models.Data.BLTeacherPost", b =>
                {
            ...
            modelBuilder.Entity("BES.Models.Data.BLTeacherPresent", b =>
                {
            ...
            modelBuilder.Entity("BES.Models.Data.BLTeacherSection", b =>
                {
            ...
            modelBuilder.Entity("BES.Models.Data.BaselineGeneral", b =>
                {
                    b.Property<short>("BLGeneralID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BES.Models.Data.District", b =>
                {
            ...
            modelBuilder.Entity("BES.Models.Data.Region", b =>
                {
                    b.Property<int>("RegionID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BES.Models.Data.School", b =>
                {
                    b.Property<int>("SchoolID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BES.Models.Data.SchoolClass", b =>
                {
                    b.Property<short>("ClassID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BES.Models.Data.Tehsil", b =>
                {
            ...
            modelBuilder.Entity("BES.Models.Data.UC", b =>
                {
                    b.Property<int>("UCID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BES.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BES.Models.Data.BLEnrollment", b =>
                {
                    b.HasOne("BES.Models.Data.BaselineGeneral", "BaselineGenerals")
                        .WithMany()
                        .HasForeignKey("BLGeneralID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BES.Models.Data.SchoolClass", "schoolClass")
                        .WithMany()
            ...
            modelBuilder.Entity("BES.Models.Data.BLFeederDetail", b =>
                {
                    b.HasOne("BES.Models.Data.BLFeederSchool", "BlFeederSchool")
                        .WithMany()
            ...
            modelBuilder.Entity("BES.Models.Data.BLLandAvailable", b =>
                {
                    b.HasOne("BES.Models.Data.BaselineGeneral", "BaselineGeneral")
                        .WithMany()
                        .HasForeignKey("BLGeneralID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("BES.Models.Data.BLTeacherSection", b =>
                {
                    ...
                    b.HasOne("BES.Models.Data.BLTeacherPost", "BLTeacherPost")
                        .WithMany()
            ...
            modelBuilder.Entity("BES.Models.Data.BaselineGeneral", b =>
                {
                    b.HasOne("BES.Models.Data.School", "School")
                        .WithMany()
            ...
            modelBuilder.Entity("BES.Models.Data.District", b =>
                {
                    b.HasOne("BES.Models.Data.Region", "Region")
                        .WithMany()
            ...
            modelBuilder.Entity("BES.Models.Data.School", b =>
                {
                    b.HasOne("BES.Models.Data.UC", "UC")
                        .WithMany()
                        .HasForeignKey("UCID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("BES.Models.Data.Tehsil", b =>
                {
                    b.HasOne("BES.Models.Data.District", "District")
                        .WithMany()
            ...
            modelBuilder.Entity("BES.Models.Data.UC", b =>
                {
                    b.HasOne("BES.Models.Data.Tehsil", "Tehsil")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BES.Data.ApplicationUser")
                        .WithMany()
